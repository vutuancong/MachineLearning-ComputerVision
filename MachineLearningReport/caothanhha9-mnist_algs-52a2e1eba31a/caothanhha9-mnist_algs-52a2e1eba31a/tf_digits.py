...
# Additional layer:
hidden_size = 10
Wh = tf.Variable(tf.truncated_normal([feature_size, hidden_size], stddev=0.1))
...
# W = tf.Variable(tf.zeros([hidden_size, label_size]))
W = tf.Variable(tf.truncated_normal([hidden_size, label_size], stddev=0.1))
